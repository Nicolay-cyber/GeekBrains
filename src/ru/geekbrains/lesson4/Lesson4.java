    ...
    static boolean hasWin(char symbol)
    {
        ...
        for (int i = 0; i < (SIZE * 2) - 1; i++)
        {
            for(int j = 0; j < SIZE - Math.abs(SIZE - (i + 1)); j ++)
            {
                ...
                if(i > (SIZE - 1))
                {
                    if(map[i-(SIZE - 1) + j][(SIZE - 1) - j] != symbol && count > 0){
                        count = 0;
                    }
                ...
                if(j == (SIZE - Math.abs(SIZE - (i + 1))) - 1 && count < DOTS_TO_WIN){
                    count = 0;
                }
            }
        ...
        for (int i = 0; i < (SIZE * 2) - 1; i++)
        {
            for(int j = 0; j < SIZE - Math.abs(SIZE - (i + 1)); j ++)
            {
                ...
                if(i > (SIZE - 1))
                {
                    if(map[j][j + i - (SIZE -1)] != symbol && count > 0){
                        count = 0;
                    }
                ...
                {
                    if(map[(SIZE - 1) - i + j][j] != symbol && count > 0)
                    {
                        count = 0;
                    }
